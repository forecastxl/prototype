...
describe('transformResponseData', () => {
  it('should convert a response properly', () => {
    const response = { errors: { base: ['base'], snake_case: ['snake_case'], multiple: ['multiple', 'values'] } }
    const expected = { errors: { _error: 'base', snakeCase: 'snake_case', multiple: 'multiple. values' } }
